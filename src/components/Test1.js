...
function Test1() {
  ...
  const Product1_data = [
    ...
    },
    {
      ...
      name: "kamble",
      color: "#F0F0F0",
      desc: "MAGICAL Floral Double Mink Blanket for Heavy Winter (Microfiber)",
      price: 479,
      full: 1999,
      off: 76,
    },
  ...
  const Product2_data = [
    ...
    },
    {
      ...
      name: "Canon",
      color: "#f2f0f0",
      desc: "Canon PIXMA E3370 Multi-function WiFi Color Inkjet Printer",
      price: 5599,
      full: 6996,
      off: 15,
    },
  ...
  return (
    <>
      ...
      <div className="bg-[#f2f0f0] w-[full] h-[70vh] flex-row flex p-[1.5vh] max-sm:flex-col max-sm:items-center max-sm:h-[113vh]">
        <div className="h-[65vh] w-[40vw] justify-around flex flex-col items-center ml-[5vw] max-sm:w-[100vw] max-sm:ml-0">
          <div className="bg-[#CAF2FF] w-[30vw] h-[30vh] rounded-2xl mt-[1vw] flex max-sm:w-[90vw]">
            <div className="h-[30vh] w-[20vw] flex-col flex justify-around max-sm:w-[60vw]">
              <p className="bg-[#FCDF5B] text-center w-[7vw] h-[2.5vh] text-[#6F6F6F] mt-[1vw] ml-[1.5vw] max-sm:w-[25vw] max-sm:mt-[3vw]">
                50% Discout
              </p>
        ...
        <div className="w-[60vw] h-[65vh] flex items-center max-sm:w-[86vw] max-sm:h-[47vh]">
          <div className="w-[50vw] h-[60vh] bg-[#FFE1E3] ml-[-1vw] rounded-2xl mt-[1vw] max-sm:h-[45vh] max-sm:w-[100vw]">
            <div className="w-[30vw] h-[25vh] flex justify-around flex-col p-[1vw] m-[1vw]">
              <p className="font-bold text-5xl max-sm:text-4xl max-sm:w-[60vw]">Lifelong Tribe 20T</p>
              <p className="text-[#6F6F6F] text-base leading-[1vw] ml-[1vw] max-sm:leading-[4vw] max-sm:w-[40vw]">
                Matte Black And Fluorescent yellow 20 T
                <br />
                Road Cycle (Single Speed, Black
              </p>
              <div className="flex flex-row justify-around w-[9vw] ml-[1vw] max-sm:w-[40vw] max-sm:z-10">
            ...
            rounded-xl shadow-md shadow-red-500/30 transition ease-in-out delay-150 hover:scale-110 duration-300 max-sm:w-[30vw] max-sm:z-10"
              >
                Buy Now
              </button>
            </div>
            <img className="relative left-[27vw] top-[-10vh] max-sm:left-[10vw]" src={Ellipse5} />
            <img className="relative left-[17vw] top-[-17vh] max-sm:hidden" src={Ellipse6} />
            <img className="relative left-[10vw] top-[-60vh] max-sm:top-[-30vh] max-sm:left-[0vw] max-sm:h-[50%]" src={image13} />
          </div>
        </div>
      </div>
      <div className="w-[full] h-[66vh] max-sm:flex max-sm:flex-col max-sm:jusyify-center max-sm:h-[105vh]">
        <p className="font-bold text-4xl p-[2vw] ml-[13vw] max-sm:ml-[0vw] max-sm:text-center">Feature Product</p>
        <div className="flex max-sm:flex-col">
          <div className="w-[24vw] h-[49vh] ml-[15vw] flex flex-col justify-between bg-my-rectan bg-cover rounded-lg
          max-sm:w-[86vw] max-sm:h-[42vh] max-sm:ml-[8vw] max-sm:mb-[2vh]">
            <div className="w-[full] flex flex-col justify-start p-[1vw]">
              <p className="text-[#FF0000] font-bold text-lg bg-white w-[7vw] max-sm:w-[25vw] max-sm:text-center">
                FURNITURE
              </p>
          ...
          <div className="grid grid-cols-3 ml-[3vw] gap-4 max-sm:grid-cols-2 max-sm:ml-[4vw]">
            <div className="w-[15vw] h-[24vh] bg-[#FCF8CC] items-center flex flex-col gap-y-[-0.5vw] rounded-xl drop-shadow-sm cursor-pointer
            max-sm:w-[20vh]">
              <p className="bg-[#474748] w-[4vw] text-center rounded-2xl text-[#fff] ml-[9vw] max-sm:mt-[1vh] text-sm
              max-sm:w-[16vw] max-sm:ml-[11vh]">
                ₹23,000
              </p>
            ...
            max-sm:w-[20vh]">
              ...
              <img className="mt-[-0.3vw] max-sm:h-[72%]" src={headphone} />
            ...
            max-sm:w-[20vh]">
              ...
              <img className="mt-[1vw] max-sm:mt-[4vw]" src={image32} />
            ...
            max-sm:w-[20vh] max-sm:gap-y-[-0vw]">
              <p className="bg-[#474748] w-[4vw] text-center rounded-2xl text-[#fff] ml-[9vw] max-sm:mt-[1vh] text-sm
              max-sm:w-[16vw] max-sm:ml-[11vh]">
                ₹2,900
              </p>
              <img className="mt-[1vw] max-sm:mt-[2vw]" src={image4} />
              <p className="font-bold max-sm:mt-[0vw]">Cooker Aluminium</p>
            </div>
            <div className="col-span-2 bg-[#DDEBFF] rounded-xl flex drop-shadow-sm cursor-pointer">
              <div className="mt-[2vw] ml-[2vw]">
                ...
                <p className="text-[#6F6F6F] text-base mt-[0.5vw] leading-[1vw] max-sm:leading-[4vw]">
                ...
                <p className="bg-[#474748] w-[6vw] text-center rounded-2xl text-[#fff] ml-[3vw] mt-[3vh] text-lg max-sm:w-[25vw]">
                  ₹60,000
                </p>
              </div>
              <div className="max-sm:flex max-sm:items-center">
              <img className="ml-[1vw] h-[23vh] mt-[0.5vw] max-sm:h-[80%] max-sm:mt-[7vw] max-sm:mr-[1vw]" src={image5} />
              </div>
            </div>
          </div>
        </div>
      </div>
      <div className="w-[full] h-[50vh] flex flex-col items-center justify-center max-sm:mt-[25vw] max-sm:h-[150vh] max-12p:h-[175vh] max-12p:mt-[0vw] max-s20:h-[160vh] max-s20:mt-[3vh]">
        {/* <p className="font-bold text-4xl p-[2vw] ml-[13vw] max-sm:text-3xl max-sm:ml-[17vw]"> */}
        <p className="font-bold text-4xl p-[2vw] max-sm:text-3xl ">
          Last View Products
        </p>
        <div className="flex justify-center items-center">
          <div className="h-[34vh] w-[80vw] flex flex-row justify-between bg-[#E1FFE4] bg-opacity-0 max-sm:flex max-sm:items-center max-sm:flex-col max-sm:h-[120vh]">
            {Product_data.map((item, index) => (
              <div
                className={`h-[34vh] w-[14vw] bg-[${item.color}] rounded-2xl drop-shadow-sm cursor-pointer max-sm:w-[65vw] max-sm:mt-[2vw]`}
                key={index}
              >
                <p className="bg-[#04BB00] text-[#fff] w-[3vw] text-center rounded-2xl m-[0.2vw] max-sm:w-[10vw]">
                  {item.point}
                </p>
                <div className="flex justify-center item-center mt-[-1vw]">
                  <div className="w-[60%] h-[8.5vw] flex justify-center items-center">
                    <img className="w-[full] max-sm:mt-[12vw]" src={item.pic} />
                  </div>
                </div>
                <p className="text-[#8B8B8B] px-[1.5vw] max-sm:mt-[15vw]">{item.name}</p>
                <p className="leading-[1vw] font-bold px-[1.5vw] max-sm:leading-[4vw]">
                  {item.desc}
                </p>
            ...
            <p className="font-bold items-center flex cursor-pointer text-[#6F6F6F] bg-[#FFEBE0] bg-opacity-0 max-sm:hidden">
              view more
            </p>
          </div>
        </div>
      ...
      <div >
      <div className="h-[55vh] bg-gradient-to-r from-[#c9d1ff] from-60% to-[#f9f4bb] items-center flex justify-center gap-x-[1vw] max-sm:flex 
      max-sm:h-[55vh] max-sm:flex-col max-sm:justify-around">
        <div
          className="h-[50vh] w-[30vw] bg-gradient-to-b from-[#7697e3] from-1% to-[#1c4aba] to-99% rounded-3xl flex flex-col
        justify-between max-sm:h-[20vh] max-sm:h-[25vh] max-sm:w-[90vw]"
        >
          <div>
            <p className="font-bold text-4xl text-[#fff] mt-[2vw] ml-[2vw] max-sm:text-2xl">
        ...
        max-sm:h-[25vh] max-sm:w-[90vw]">
          <p className=" text-6xl text-[#fff] mt-[4vw] ml-[2vw] max-sm:text-3xl max-sm:mt-[2vw] max-sm:font-bold">
            Gift Card for
            <br /> 
            Corporate and
            <br />
          ...
          <p className="text-[#fff] text-lg leading-[1vw] ml-[2vw] max-sm:hidden">
      ...
      <div className="h-[57vh] w-[full] max-sm:h-[51vh]">
        <p className="font-bold text-4xl p-[2vw] ml-[13vw] max-sm:text-2xl max-sm:ml-[23vw]">
          Shop By Categories
        </p>
        <div className="flex justify-center">
          <div className="w-[75vw] h-[-42vh] flex flex-row justify-around max-sm:flex-col max-sm:gap-[3vw] max-sm:w-[95vw] max-sm:gap-y-[2vw]">
            <div className="max-sm:flex flex flex-row gap-[2vw]" >
            <div className="h-[42vh] w-[17vw] bg-[#FFE99D] flex justify-between flex-col rounded-3xl cursor-pointer max-sm:w-[80vw] max-sm:h-[22vh]">
              <p className="font-bold text-3xl m-[1vw] max-sm:text-xl max-sm:ml-[5vw] max-sm:mt-[2vw]">Fashion</p>
              <img className="h-[90%] mt-[-3vw] max-sm:h-[80%] " src={image15} />
            </div>
            <div className="h-[42vh] w-[17vw] bg-[#FFC7CA] flex justify-between flex-col rounded-3xl cursor-pointer max-sm:w-[80vw] max-sm:h-[22vh]">
              <p className="font-bold text-3xl m-[1vw] max-sm:ml-[5vw] max-sm:text-xl max-sm:mt-[2vw]">Beauty & Accessories</p>
              < img className="h-[90%] mt-[-2vw] max-sm:h-[80%] " src={image16}/>
            </div>
            </div>
            <div className="max-sm:flex flex flex-row gap-[2vw]" >
            <div className="h-[42vh] w-[17vw] bg-[#D1E4FF] flex justify-between flex-col rounded-3xl cursor-pointer max-sm:w-[80vw] max-sm:h-[22vh]">
              <p className="font-bold text-3xl m-[1vw] max-sm:ml-[5vw] max-sm:text-xl max-sm:mt-[2vw]">Electronics</p>
              < img className="h-[90%] mt-[-2vw] max-sm:h-[80%] " src={image17}/>
            </div>
            <div className="h-[42vh] w-[17vw] bg-[#CBFFD0] flex justify-between flex-col rounded-3xl cursor-pointer max-sm:w-[80vw] max-sm:h-[22vh]">
              <p className="font-bold text-3xl m-[1vw] max-sm:ml-[5vw] max-sm:text-xl max-sm:mt-[2vw]">Grocery</p>
              < img className="h-[90%] mt-[-1vw] max-sm:h-[80%]" src={image18}/>
            </div>
            </div>
          </div>
        </div>
      ...
      <div className="w-[full] h-[50vh] max-sm:h-[142vh]">
        <p className="font-bold text-4xl p-[2vw] ml-[13vw] max-sm:text-2xl max-sm:ml-[17vw]">
          Winter Essentials
        </p>
        <div className="flex justify-center">
          <div className="h-[34vh] w-[80vw] flex flex-row justify-between max-sm:flex max-sm:items-center max-sm:flex-col max-sm:h-[120vh]">
            ...
            <p className="font-bold items-center flex cursor-pointer text-[#6F6F6F] bg-[#F0F0F0] bg-opacity-0 max-sm:hidden">
              view more
            </p>
          </div>
        </div>
      ...
      <div className="w-[full] h-[50vh] max-sm:h-[135vh] max-12p:h-[145vh]">
        <p className="font-bold text-4xl p-[2vw] ml-[13vw] max-sm:text-2xl max-sm:ml-[17vw] max-12p:mt-[6vh]">
        ...
        <div className="flex justify-center">
          <div className="h-[34vh] w-[80vw] flex flex-row justify-between max-sm:flex max-sm:items-center max-sm:flex-col max-sm:h-[120vh]">
            ...
            <p className="font-bold items-center flex cursor-pointer text-[#6F6F6F] bg-[#F3ECD6] bg-opacity-0 max-sm:hidden">
              view more
            </p>
          </div>
        </div>
      ...
      <div className="h-[60vh] w-[full] flex justify-center items-center">
        <div className="h-[50vh] w-[70vw] bg-gradient-to-r from-[#40a9e2] to-[#67df88] rounded-3xl flex max-sm:flex-col max-sm:w-[90vw] max-s20:mt-[5vh]">
          <div className="h-[40vh] w-[60vh] flex flex-col justify-around m-[3vw] ">
            <p className="font-bold text-5xl text-[#082C4D] max-sm:text-3xl">
              Flipkart Grocery:{" "}
            ...
            <button className="text-[#04BB00] text-2xl font-bold ml-[1vw] items-center w-[12vw] h-[7vh] bg-[#fff] text-lg cursor-pointer rounded-3xl shadow-md shadow-[#000]/30 
            transition ease-in-out delay-150 hover:scale-110 duration-300 max-sm:w-[35vw] max-sm:mt-[3vw]">
              UP TO 30% OF
            </button>
          </div>
          <img className="items-center flex h-[90%] max-sm:mt-[-10vw]" src={image31} />
        </div>
      </div>

      <div className="w-[full] h-[45vh] bg-[#031828] flex justify-center items-center flex-col max-sm:h-[35vh]">
        <div className="h-[30vh] w-[75vw] flex flex-row justify-around items-center">
          <div className="h-25vh w-[20vh] mt-[-1vw] max-sm:hidden">
          ...
          <div className="mt-[1vw] max-sm:hidden">
            <p className="font-bold text-[#fff] text-lg cursor-pointer">
              MAIL Us:
            </p>
            <p className="text-[#fff] text-lg">
        ...
        <div className="h-[4vh] w-[30vw] mr-[22vw] flex flex-row justify-between max-sm:mr-[0vw] max-sm:w-[110vw]">
          <div className="flex flex-row items-center gap-x-[0.5vw] ">
            <p className="text-[#fff] text-sm max-sm:text-[3vw] max-sm:ml-[17vw]">Become a Seller</p>
            <img src={Line14} />
            <p className="text-[#fff] text-sm max-sm:text-[3vw]">Advertise</p>
            <img src={Line14} />
            <p className="text-[#fff] text-sm max-sm:text-[3vw]">Gift Cards</p>
            <img src={Line14} />
            <p className="text-[#fff] text-sm max-sm:text-[3vw]">Help Center</p>
          </div>
          <div className="items-center flex ">
            <p className="text-[#fff] text-sm max-sm:hidden">© 2007-2022 Flipkart.com</p>
          </div>
        </div>
      </div>
    </>
